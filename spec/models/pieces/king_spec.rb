  ...
  describe 'castle!' do
    ...
    context 'queen side castle' do
      it 'should update attributes' do
        black_king.castle!(queen_side_black_rook)
    ...
    context 'king side castle' do
      it 'should update attributes' do
        black_king.castle!(king_side_black_rook)

        black_king.reload
        king_side_black_rook.reload

        expect(black_king.column_coordinate).to eq 6
        expect(king_side_black_rook.column_coordinate).to eq 5
      end
    end
  end
